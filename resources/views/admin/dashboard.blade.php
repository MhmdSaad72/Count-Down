    ...
    <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="card rounded-lg card-striped card-striped-gradient-success">
                <div class="card-body rounded-lg bg-white shadow-sm p-lg-4">
                    <h2 class="h5 text-uppercase letter-spacing-0 mb-0 fw-bold">All subscribers</h2>
                    <p class="text-gray-500 mb-4">Users that confirmed their emails</p>
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="card rounded-lg card-striped card-striped-gradient-danger">
                <div class="card-body rounded-lg bg-white shadow-sm p-lg-4">
                    <h2 class="h5 text-uppercase letter-spacing-0 mb-0 fw-bold">New subscribers</h2>
                    <p class="text-gray-500 mb-4">Users that haven't</p>
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="card rounded-lg card-striped card-striped-gradient-info">
                <div class="card-body rounded-lg bg-white shadow-sm p-lg-4">
                    <h2 class="h5 text-uppercase letter-spacing-0 mb-0 fw-bold">Page views</h2>
                    <p class="text-gray-500 mb-4">All the subscribers all time</p>
