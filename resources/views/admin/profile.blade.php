  ...
  @endif
    ...
    <div class="alert alert-info mb-4" role="alert">
        <p class="mb-0">
            ...
            Leave the password fields blank if you are not interested to change.
        </p>
    </div>
      ...
      @method('PATCH')
        <div class="row gy-4">
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0 required" for="fullName">Full name</label>
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0 required" for="userName">Username</label>
                <p class="form-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0 required" for="userEmail">Email address</label>
                <p class="form-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0" for="userPasswordCurrent">Current password</label>
                <p class="form-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0" for="userPasswordNew">New password</label>
                <p class="form-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
            ...
            <div class="form-group col-lg-6">
                <!-- Input-->
                <label class="form-label h5 mb-0" for="userPasswordNewConfirmation">Retype new password</label>
                <p class="form-text mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
