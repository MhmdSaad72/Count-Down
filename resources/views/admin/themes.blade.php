    ...
    <div class="row gy-5 mb-4">
      @foreach ($all_themes as $key => $value)
        ...
        <div class="col-lg-6">
          ...
          <p class="text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
          <!-- Theme Item Card-->
          <div class="card theme-card shadow rounded-lg" style="background: url({{ $value->activeImage() ?? asset('img/index1.png')}})">
            <div class="card-overlay p-3">
              <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item">
                  <a class="btn btn-light bg-white btn-sm edit-btn" href="{{ route('single-theme' , $value->id) }}">Edit theme</a>
                </li>
              </ul>
            </div>
          </div>
